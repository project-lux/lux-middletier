...
export function getNumArg(value, defaultValue) {
...
export function replaceStringsInObject(obj, fromStr, toStr) {
 ...
 */
export function nanoSecToString(nanoSec) {
