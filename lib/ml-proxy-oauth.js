...
import './ml-generated/lux.cjs'

function createMLClient(oauthToken) {
...
export class MLProxy {
  constructor(oauthToken) {
    console.log('MLProxy#constructor oauthToken:', oauthToken)
    const mlClient = createMLClient(oauthToken)
