...
const exampleDocs = {
  ...
  concepts: [
    ...
    'concept/88af90e3-d194-4bfb-aa8c-0998cdf7e679', // exhibitions - http://vocab.getty.edu/aat/300054766
  ],
  events: [
...
for (const [scope, halLinkInfo] of Object.entries(successfulHalLinks)) {
