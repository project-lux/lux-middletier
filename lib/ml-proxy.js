...
import TenantStatus from './ml-generated/tenantStatus.cjs'
...
class MLProxy {
  ...
  initOAuth(oauthToken, username) {
    try {
      ...
      this.tenantStatus = TenantStatus.on(mlClient)
  ...
  updateDocument(unitName, uri, doc, lang = null) {
    return this.documentServices.update(unitName, uri, doc, lang)
  }

  deleteDocument(uri) {
    return this.documentServices.delete(uri)
  }

  getTenantStatus() {
    return this.tenantStatus.get()
  }
