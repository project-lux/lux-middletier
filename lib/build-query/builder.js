...
const keyFuncNameMap = {
  agent: {
    ...
    'lux:agentCreatedPublishedInfluencedSet':
      queries.setCreatedPublishedInfluencedByAgent.name,
    ...
    'lux:agentInfluencedItemsTime': queries.itemsInfluencedByAgents.name,
    'lux:agentInfluencedWorksTime': queries.worksInfluencedByAgents.name,
    ...
    'lux:agentRelatedEvents': queries.eventsRelatedToAgent.name,
    ...
    'lux:agentSetCreatedTime': queries.setCreatedPublishedInfluencedByAgent.name,
    'lux:agentSetPublishedTime': queries.setCreatedPublishedInfluencedByAgent.name,
    'lux:agentSetTypes': queries.setsRelatedToAgent.name,
    'lux:agentWorkAbout': queries.worksAboutAgent.name,
    'lux:agentWorkAboutTime': queries.worksAboutAgent.name,
  ...
  concept: {
    ...
    'lux:conceptRelatedSets': queries.setsRelatedToConcept.name,
  ...
  event: {
    ...
    'lux:eventItemIncludedTime': queries.itemsForEvent.name,
    ...
    'lux:eventSetsAboutTime': queries.setAboutEvent.name,
    'lux:eventSetsCausedByTime': queries.setCausedByEvent.name,
    'lux:eventSetTypes': queries.setForEventSetType.name,
    'lux:eventWorksAbout': queries.worksAboutEvent.name,
    'lux:eventWorksAboutTime': queries.worksAboutEvent.name,
    'lux:eventWorksCausedByTime': queries.worksCausedByEvent.name,
  ...
  place: {
    ...
    'lux:placeCreatedPublishedWork': queries.worksCreatedPublishedAtPlace.name,
...
const queryBuilders = {
  ...
  'lux:agentCreatedPublishedInfluencedSet': (id) => {
    const q = prepareQuery(queries.setCreatedPublishedInfluencedByAgent(id))
  ...
  'lux:agentInfluencedItemsTime': (id) => {
    const q = prepareQuery(queries.itemsInfluencedByAgents(id))
    return `${config.searchUriHost}/api/facets/item?q=${q}&name=itemProductionDate`
  },
  'lux:agentInfluencedWorksTime': (id) => {
    const q = prepareQuery(queries.worksInfluencedByAgents(id))
  ...
  'lux:agentRelatedEvents': (id) => {
    const idEnc = encodeURIComponent(id)
    return `${config.searchUriHost}/api/related-list/event?&name=relatedToAgent&uri=${idEnc}`
  },
  ...
  'lux:agentSetCreatedTime': (id) => {
    const q = prepareQuery(queries.setCreatedPublishedInfluencedByAgent(id))
    return `${config.searchUriHost}/api/facets/set?q=${q}&name=setCreationDate`
  },
  'lux:agentSetPublishedTime': (id) => {
    const q = prepareQuery(queries.setCreatedPublishedInfluencedByAgent(id))
    return `${config.searchUriHost}/api/facets/set?q=${q}&name=setPublicationDate`
  },
  'lux:agentWorkAbout': (id) => {
    const q = prepareQuery(queries.worksAboutAgent(id))
    return `${config.searchUriHost}/api/search/work?q=${q}`
  },
  'lux:agentWorkAboutTime': (id) => {
    const q = prepareQuery(queries.worksAboutAgent(id))
  ...
  'lux:conceptRelatedSets': (id) => {
    const q = prepareQuery(queries.setsRelatedToConcept(id))
    return `${config.searchUriHost}/api/search/set?q=${q}`
  },
  ...
  'lux:eventSetsAboutTime': (id) => {
    const q = prepareQuery(queries.setAboutEvent(id))
    return `${config.searchUriHost}/api/facets/set?q=${q}&name=setCreationOrPublicationDate`
  },
  'lux:eventSetsCausedByTime': (id) => {
  ...
  'lux:eventWorksAboutTime': (id) => {
    const q = prepareQuery(queries.worksAboutEvent(id))
    return `${config.searchUriHost}/api/facets/work?q=${q}&name=workCreationOrPublicationDate`
  },
  'lux:eventWorksCausedByTime': (id) => {
    const q = prepareQuery(queries.worksCausedByEvent(id))
    return `${config.searchUriHost}/api/facets/work?q=${q}&name=workCreationOrPublicationDate`
  },
  ...
  'lux:placeCreatedPublishedWork': (id) => {
    const q = prepareQuery(queries.worksCreatedPublishedAtPlace(id))
    return `${config.searchUriHost}/api/search/work?q=${q}`
  },
