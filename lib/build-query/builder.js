...
const worksAboutItem = require('./queries/worksAboutItem')
const worksAboutPlace = require('./queries/worksAboutPlace')
const worksAboutWork = require('./queries/worksAboutWork')
...
const buildItemEstimatesQuery = (doc) => ({
  ...
  'lux:itemWorkAbout': worksAboutItem(doc.id),
})
...
const buildWorkEstimatesQuery = (doc) => ({
  ...
  'lux:workWorkAbout': worksAboutWork(doc.id),
})
...
const queryBuilders = {
  ...
  'lux:itemWorkAbout': (id) => {
    const q = prepareQuery(worksAboutItem(id))
    return `${config.searchUriHost}/api/search/work?q=${q}`
  },
  ...
  'lux:workWorkAbout': (id) => {
    const q = prepareQuery(worksAboutWork(id))
    return `${config.searchUriHost}/api/search/work?q=${q}`
  },
}
