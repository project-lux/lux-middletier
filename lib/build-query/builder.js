...
const itemsProductionInfluenced = require('./queries/itemsProductionInfluencedByAgent')
...
const worksCreationInfluenced = require('./queries/worksCreationInfluencedByAgent')
...
const buildAgentEstimatesQuery = (doc) => ({
  ...
  'lux:agentItemProductionInfluenced': itemsProductionInfluenced(doc.id),
  ...
  'lux:agentWorkCreationInfluenced': worksCreationInfluenced(doc.id),
...
const queryBuilders = {
  ...
  'lux:agentItemProductionInfluenced': (id) => {
    const q = prepareQuery(itemsProductionInfluenced(id))
  ...
  'lux:agentWorkCreationInfluenced': (id) => {
    const q = prepareQuery(worksCreationInfluenced(id))
    return `${config.searchUriHost}/api/search/work?q=${q}`
  },
