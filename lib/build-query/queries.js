...
import eventsRelatedToAgent from './queries/eventsRelatedToAgent.js'
...
import itemsEncounteredAtPlace from './queries/itemsEncounteredAtPlace.js'
...
import itemsInfluencedByAgents from './queries/itemsInfluencedByAgents.js'
...
import itemsOrSetsMemberOfSet from './queries/itemsOrSetsMemberOfSet'
...
import setAboutAgent from './queries/setAboutAgent.js'
import setAboutEvent from './queries/setAboutEvent.js'
import setAboutPlace from './queries/setAboutPlace.js'
import setById from './queries/setById.js'
import setCausedByEvent from './queries/setCausedByEvent.js'
import setCreatedAtPlace from './queries/setCreatedAtPlace.js'
import setCreatedPublishedInfluencedByAgent from './queries/setCreatedPublishedInfluencedByAgent.js'
import setForEventSetType from './queries/setForEventSetType.js'
import setsRelatedToAgent from './queries/setsRelatedToAgent.js'
import setsRelatedToConcept from './queries/setsRelatedToConcept.js'
import setsRelatedToPlace from './queries/setsRelatedToPlace.js'
...
import worksCreatedPublishedAtPlace from './queries/worksCreatedPublishedAtPlace.js'
...
import worksInfluencedByAgents from './queries/worksInfluencedByAgents.js'
...
const queries = {
  ...
  setCausedByEvent,
  setCreatedAtPlace,
  setCreatedPublishedInfluencedByAgent,
  setForEventSetType,
  setsRelatedToAgent,
  setsRelatedToConcept,
  setsRelatedToPlace,
  worksAboutAgent,
  worksAboutEvent,
  worksAboutItem,
  ...
  worksCreatedAtPlace,
  worksCreatedByAgent,
  worksCreatedPublishedAtPlace,
  worksCreatedPublishedInfluencedByAgent,
  worksForEvent,
  worksInfluencedByAgents,
  worksInWork,
