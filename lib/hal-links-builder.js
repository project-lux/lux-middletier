...
class HalLinksBuilder {
  constructor(mlProxy, unitName, options = {}) {
    ...
    this.timeoutMs = options.timeoutMs || 60000; // TODO: Make configurable

    // Validate and set batchSize
    this.batchSize = Math.max(1, options.batchSize || 6); // TODO: Make configurable

    // Validate and set maxConcurrentBatches
    this.maxConcurrentBatches = Math.max(1, options.maxConcurrentBatches || 2); // TODO: Make configurable
