...
class Lux {
  ...
  */
  ...
  /**
  * Invokes the dataConstants operation on the database server.
  * @returns {Promise} object value of the jsonDocument data type
  */
  dataConstants() {
    return this.$mlProxy.execute("dataConstants", {}, arguments.length);
  }
  /**
  ...
  * @returns {Promise} object value of the jsonDocument data type
  */
  facets(name, q, scope, page, pageLength) {
  ...
  /**
  * Invokes the personRoles operation on the database server.
  * @param {string} uri - provides an input value of the string datatype
  * @returns {Promise} object value of the jsonDocument data type
  */
  personRoles(uri) {
    return this.$mlProxy.execute("personRoles", {
      "uri": uri
    }, arguments.length);
  }
  /**
  ...
  * @returns {Promise} object value of the jsonDocument data type
  */
  search(q, scope, mayChangeScope, page, pageLength, sort, facetsSoon, synonymsEnabled) {
