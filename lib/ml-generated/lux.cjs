...
class Lux {
  ...
  */
  ...
  /**
  * Invokes the scaleOut operation on the database server.
  * @param {string} dynamicHost - provides an input value of the string datatype
  * @returns {Promise} for success or failure
  */
  scaleOut(dynamicHost) {
    return this.$mlProxy.execute("scaleOut", {
  ...
  * @returns {Promise} object value of the jsonDocument data type
  */
  search(unitName, q, scope, page, pageLength, pageWith, sort, filterResults) {
  ...
  */
  ...
  /**
  * Invokes the validateDataset operation on the database server.
  * @param {string} [unitNames] - provides an input value of the string datatype,
  * @param {string} [categories] - provides an input value of the string datatype,
  * @param {array|Buffer|Map|Set|stream.Readable|string} [testConfig] - provides an input value of the jsonDocument datatype,
  * @param {array|Buffer|Map|Set|stream.Readable|string} [baseline] - provides an input value of the jsonDocument datatype,
  * @param {string} [baselineId] - provides an input value of the string datatype,
  * @param {string} [format] - provides an input value of the string datatype
  * @returns {Promise} object value of the jsonDocument data type
  */
  validateDataset(unitNames, categories, testConfig, baseline, baselineId, format) {
    return this.$mlProxy.execute("validateDataset", {
      "unitNames": unitNames,
